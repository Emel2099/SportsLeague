...
// GET retorna 200 (Ok), POST retorna 201 (CreatedAtAction con la URL del recurso creado),
// PUT/DELETE retornan 204 (NoContent), errores de validación retornan 409 (Conflict),
// y recursos no encontrados retornan 404 (NotFound).


[ApiController] //Si el modelo no es correcto devuelve el error 400 bad request
